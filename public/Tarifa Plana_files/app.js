...
(function ($) {
	...
	$.fn.onScreenKeyboard = function (options) {
		...
		var $shiftKey = $keyboard.children('li.osk-shift');
		var $spaceKey = $keyboard.children('li.osk-space');
		var $mayusKey = $keyboard.children('li.osk-capslock');
		var shift = false;
		var capslock = false;
		var inputOptions = [];
		...
		function activateInput($input) {
			...
			if (inputOptionsString !== undefined) {
				...
				if ($.inArray('disableLetters', inputOptions) > -1) {
					$letterKeys.addClass('osk-disabled');
				}
				if ($.inArray('disableNumbers', inputOptions) > -1) {
					$numberKeys.addClass('osk-disabled');
				}
				if ($.inArray('disableShift', inputOptions) > -1) {
					$shiftKey.addClass('osk-disabled');
				}
				if ($.inArray('disableSpace', inputOptions) > -1) {
					$spaceKey.addClass('osk-disabled');
				}
				if ($.inArray('disableMayus', inputOptions) > -1) {
					$mayusKey.addClass('osk-disabled');
				}
		...
		$keyboard.css('bottom', settings.topPosition).css('left', settings.leftPosition);
		...
		$keyboard = $(
			'<ul id="' + keyboardId + '">' +
				...
				'<li class="osk-symbol">' +
					'<span class="osk-off"></span>' +
				'</li>' +
				'<li class="osk-backspace osk-last-item">Borrar</li>' +
				...
				'<li class="osk-symbol osk-last-item">' +
					'<span class="osk-off"></span>' +
				'</li>' +
				'<li class="osk-capslock">Mayús</li>' +
				...
				'<li class="osk-letter">ñ</li>' +
				'<li class="osk-symbol">' +
					'<span class="osk-off"></span>' +
				'</li>' +
				'<li class="osk-return osk-last-item">Aceptar</li>' +
				...
				'<li class="osk-symbol">' +
					'<span class="osk-off"></span>' +
				'</li>' +
				'<li class="osk-hide osk-last-item">Cerrar</li>' +
				'<li class="osk-space osk-last-item">Espacio</li>' +
			'</ul>'
		);
